...
class SpaceObjectTest {
    ...
    void assureWithingBordersTest(){
        ...
        Assertions.assertEquals(player.width/2, player.getX());

        x = 1281;
        player.setX(x);
        player.assureObjectWithinBorders();
        Assertions.assertEquals(Game.WIDTH - player.width/2, player.getX());
        ...
        player.setY(y);
        player.assureObjectWithinBorders();
        Assertions.assertEquals(player.height/2, player.getY());

        y = 800;
        player.setY(y);
        player.assureObjectWithinBorders();
        Assertions.assertEquals(Game.HEIGHT - player.height/2, player.getY());
    }
